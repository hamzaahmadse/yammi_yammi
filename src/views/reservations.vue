<template>
  <div class="container-fluid">
    <div class="col-md-12 page-content">
      ...
      <h1 class="page-title"><i class="fas fa-coffee"></i> MY RESERVATIONS</h1>

      <!-- Custom Tabs -->
      <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
          <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><b>CURRENT RESERVATIONS</b><div class="ripple-container"></div></a></li>

          <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false"><b>ACCEPTED RESERVATIONS</b><div class="ripple-container"></div></a></li>

          <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false"><b>DENIED RESERVATIONS</b></a></li>

          <li class=""><a href="#tab_4" data-toggle="tab" aria-expanded="false"><b>RESERVATIONS DONE</b></a></li>

          <li class=""><a href="#tab_4" data-toggle="tab" aria-expanded="false"><b>ALL RESERVATIONS</b></a></li>
              ...
              <div class="row">
                <div class="col-sm-12">
                  <table id="example1" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="example1_info">
                    <thead>
                    <tr role="row">
                      <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Order ID: activate to sort column descending" style="width: 61px;">Order ID</th>
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Order Cash: activate to sort column ascending" style="width: 80px;">Reservation for</th>

                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Order Paypal: activate to sort column ascending" style="width: 94px;">Reservation Type</th>

                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Order Sofort: activate to sort column ascending" style="width: 90px;">Reservation Time</th>

                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Sub Total: activate to sort column ascending" style="width: 68px;">Paid</th>

                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Sub Total: activate to sort column ascending" style="width: 68px;">Adult</th>

                      <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Sub Total: activate to sort column ascending" style="width: 68px;">Kids</th>
                      ...
                      <th style="width: 85px;" class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Options: activate to sort column ascending">Options</th>
              ...
              <div class="col-sm-6">
                <div id="example1_filter" class="dataTables_filter"><label>Search:
                  ...
                  <div class="form-group form-group-sm is-empty">
                    ...
                    <span class="material-input"></span></div></label></div>
              </div>
            </div>
    ...
    <!-- Start Orders PopUp  Modal -->
    <div class="modal fade in" id="add-orders-Popup" tabindex="-1" role="dialog">
      <div class="modal-dialog narrow" role="document" style="width: 800px!important;margin-top: 35px;">


        <div class="modal-content"><div class="modal-header"><a href="#" class="btn btn-sm btn-info DataTable__Action--Button" style="margin-right: 15px">Send Mail</a>
          <a href="#" class="btn btn-sm btn-primary DataTable__Action--Button">
            Print
          </a>
          <button type="button" class="close" data-dismiss="modal" style="font-size: 21px"><span aria-hidden="true">×</span></button>

        </div><div class="modal-body"><div size="A4" layout="portrait"><div align="center" class="header"></div><div class="page-heading invoice-to"><h3>Invoice to User</h3></div><div class="first-content"><table width="100%" class="Invoice__To"><tbody><tr><td align="left"><div class="identity"><p align="left">
          ...
          </table></div><div class="right-table"><hr align="right" style="width: 39.5%;"><table width="40%" border="0" align="right" cellspacing="0" class="sub-total Invoice__SummeryTable"><tbody><tr class="border_bottom"><td style="font-weight: bold;">Sub Total</td><td align="right" style="font-weight: bold;">2.000,00 €</td></tr><tr style="background-color: rgb(242, 242, 242);"><td style="border-top: 2px solid rgb(217, 217, 217);">+ 19 %</td><td align="right" style="border-top: 2px solid rgb(217, 217, 217);">380,00 €</td></tr><tr class="border_bottom"><td style="font-weight: bold; font-size: large;">Total</td><td align="right" style="font-weight: bold; font-size: large;">2.000,00 €</td></tr></tbody></table></div><br><div class="bottom-table Invoice__BottomTable"><table width="100%" border="1"><tbody><tr><th>Notifications</th></tr><tr><td class="payment-release">Payment can´t be Released without your Permission</td></tr></tbody></table></div></div></div></div>
